...
cmd . /build/venv/bin/activate && export CUDA_HOME=/usr/local/cuda && python3 ./llama.py --temperature 1 -m /app/models/llm/TheBloke/Speechless-Llama2-Hermes-Orca-Platypus-WizardLM-13B-GPTQ/gptq-4bit-32g-actorder_True/ -mode llama --port ${CONTAINER_API_PORT:-5050}