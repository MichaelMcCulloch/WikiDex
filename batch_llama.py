...
model_directory =  "models/llm/TheBloke/Speechless-Llama2-Hermes-Orca-Platypus-WizardLM-13B-GPTQ/gptq-4bit-32g-actorder_True"
...
print(output)
print()
print(f"Response generated in {time_total:.2f} seconds, {generator.token_count} tokens, {generator.token_count / time_total:.2f} tokens/second")
